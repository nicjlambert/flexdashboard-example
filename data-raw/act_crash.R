...
#-------------------------------------------------------------------------------
# ACT crash dara sourced from https://www.data.act.gov.au/Transport/ACT-Road-Crash-Data/6jn4-m8rx
...
#-------------------------------------------------------------------------------
# point data
point <- read.csv("data-raw/ACT_Road_Crash_Data.csv") %>%
  clean_names() %>%
...
shp <- st_read("data-raw/SA2_2016_AUST.shp") %>%
  clean_names() %>%
